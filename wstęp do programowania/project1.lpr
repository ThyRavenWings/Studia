...
begin
   writeln;
   Writeln('1 - Wylosuj macierz');
   Writeln('2 - Zapisz macierz do pliku');
   Writeln('3 - Odczytaj macierz z pliku');
   Writeln('4 - Policz  sume cyfr z macierzy');
   Writeln('5 - Odczytaj slowo na glownej przekatenj (macierz musi byc kwadratowa)');
   Writeln('6 - Policz ile nieliter jest w macierzy ');
   Writeln('7 - Wyswietl numer wiersza w ktorym jest najdluzszy ciag zlozony z liter');
   Writeln('8 - Policz samogloski w macierzy');
   Writeln('9 - Zmien wymiary macierzy');
   Writeln('0 - Zamiknij program');
   writeln;
end;
